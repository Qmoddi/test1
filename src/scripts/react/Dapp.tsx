      ...
      <>
        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            The Entroverts is an Ethereum collection of 5,555 Entroverts made by The Artist Tari. An entrovert is an individual who was once an outgoing person, but somewhere along the line they faced some type of trauma that has caused them to retract from society. This project is dedicated to those individuals and the focus on destigmatizing mental health issues.Joining this project means joining a movement to change the narrative.
